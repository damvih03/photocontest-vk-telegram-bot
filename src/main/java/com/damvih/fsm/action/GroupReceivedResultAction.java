...
@Component
public class GroupReceivedResultAction implements Action<ResultState, ResultEvent> {
    ...
    public void execute(StateContext<ResultState, ResultEvent> stateContext) {
        ...
        Long groupId = Long.valueOf(update.getMessage().getText());
        stateContext.getExtendedState().getVariables().put("groupId", groupId);
    }
